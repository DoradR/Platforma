        ...
        <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="me-auto">
                ...
                <Nav.Link href='/live' onClick={handleLiveClick}>LIVE</Nav.Link>

                </Nav>
                <Nav style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>

                {userInfo && userInfo.isAdmin && (
                  <NavDropdown title={(<NavbarBrand style={{fontSize: '2rem', textTransform: 'uppercase'}}><RiAdminFill/>Admin</NavbarBrand>)} id='adminmenu' style={{display: 'flex', alignItems: 'center',fontSize:'2rem'}}>
                ...
                {userInfo ? (
                    <NavDropdown title={(<NavbarBrand style={{fontSize: '2rem', textTransform: 'uppercase'}}><FaUser/>User</NavbarBrand>)} id='username' style={{fontSize:'2rem'}} drop={'start'}>
